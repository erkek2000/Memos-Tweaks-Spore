@{
    # Crash-isolation preset: EMPTY DLL. Every runtime switch is off; the DLL
    # only registers with ModAPI and does nothing else. Package settings are
    # identical to the default release. If this still crashes on planet entry,
    # the cause is outside all runtime features (package, ModAPI, or vanilla).
