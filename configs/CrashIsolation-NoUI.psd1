@{
    # Crash-isolation preset: identical package settings to the default
    # release, with every runtime UI feature compiled out. Used to answer
    # whether the planet-entry crash comes from the UI hooks or from the
    # data hooks (bio protector detour, cargo limit, galaxy spice collector).
